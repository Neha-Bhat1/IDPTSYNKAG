            ...
            <div className="bg-white/15 backdrop-blur-sm rounded-2xl border border-white/20 p-5 min-w-[220px]">
              ...
              <div className="space-y-2">
                {[
                  ...
                  { label: "Population", value: "3.87 Crore" },
      ...
      <main className="max-w-5xl mx-auto px-6 py-12 space-y-16">
        ...
        <Section title="Brief Introduction" icon="📜">
          ...
          >
            ...
            <p className="text-foreground">
              Its history stretches back to the 9th century BCE, as noted in the Rigveda’s Aitareya Brahmana, and the region has been shaped by a succession of major dynasties including the Satavahanas, Kakatiyas, and the Qutb Shahis. After centuries of diverse rule and a period under the British Raj, the Telugu-speaking regions were eventually regrouped into Andhra Pradesh following Indian Independence. However, persistent social movements led to the state's formal bifurcation and the creation of Telangana in 2014. 
            </p>
            <p className="text-foreground">
