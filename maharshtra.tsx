...
import mahaMap from "@assets/mahaMap.jpg";
const gudi1 = "";
const gudi2 = "";
const ganesh1 = "";
const ganesh2 = "";
        ...
        <Section title="Brief Introduction" icon="📜">
          ...
          >
            ...
            <p className="text-foreground italic text-primary font-medium">
              The state has played a significant role in the country's social and political life and is widely considered a leader in terms of agricultural and industrial production, trade and transport, and education.
            </p>
            <p className="text-xs text-muted-foreground">
...
const artGallery = [
  ...
  {
    title: "Miniature paintings of Nashik",
    emoji: "🌸",
    color: "#F4D8E8",
    desc: "",
    image: gNashik,
  ...
  {
    title: "Dhokra & Tribal Metal Craft",
    emoji: "🥐",
    color: "#F4E884",
    desc: "",
    image: gDhokra,
  },
  {
    ...
    emoji: "🍨",
    color: "#E8C8E8",
    desc: "The undisputed king of Mumbai street food. It consists of a spicy, deep-fried potato dumpling (vada) sandwiched inside a soft bread bun (pav), layered with fiery garlic chutney and green chillies",
    image: gVadapav,
  },
  {
  ...
  },
  {
    ...
    emoji: "🔮",
    color: "#E8F4F8",
    desc: "The ultimate festive sweet flatbread. It is prepared by stuffing wheat dough with a sweet mixture of cooked chana dal (bengal gram) and jaggery, flavored with cardamom, and roasted with generous amounts of pure ghee.",
    image: gPuran,
  },
  {
    title: "Misal Pav",
    emoji: "🥭",
    color: "#F8C840",
    desc: "A fiery breakfast dish made of a spicy sprout curry (usal) topped with farsan (crispy snacks), onions, and lemon, served with buttered pav. Regional variations like the smoky Kolhapuri Misal or the spice-packed Nashik Misal have cult followings.",
    image: gMisal,
  },
  {
    ...
    emoji: "🌿",
    color: "#F4B830",
    desc: "A savory, crisp snack made by steaming a thick batter of fresh coriander leaves (kothimbir) and chickpea flour (besan), which is then sliced into squares and shallow or deep-fried",
    image: gKothimbir,
  },
  {
    title: "Bhakarwadi",
    emoji: "👕",
    color: "#B4D8E8",
    desc: "Popular, crispy, and bite-sized Indian snack from Maharashtrat. It is made of a fried gram flour pastry rolled tightly around a tangy, spicy, and sweet filling of coconut, sesame seeds, and aromatic spices",
    image: gBhakarwadi,
  },
  {
    title: "Pithla-Bhakri",
    emoji: "🥻",
    color: "#D4A4E8",
    desc: "Known as the comfort food of rural Maharashtra. Pithla is a thick, comforting chickpea flour porridge cooked with green chillies, garlic, and mustard seeds. It is traditionally paired with Bhakri—a rustic, unleavened flatbread made from jowar or bajra (pearl millet).",
    image: gPithla,
  },
  {
    title: "Thalipeeth",
    emoji: "🧣",
    color: "#E8A8C8",
    desc: "A highly nutritious, savory multi-grain flatbread made from bhajani—a flour blend of roasted grains and pulses including jowar, bajra, wheat, rice, and chana dal. The dough is patted directly onto a hot griddle with chopped onions, coriander, and spices, leaving small holes in the center to pour ghee while cooking.",
    image: gThalipeeth,
  },
  {
    title: "Alu Vadi",
    emoji: "💃",
    color: "#E88844",
    desc: "A brilliant sweet, spicy, and tangy snack made by spreading a thick paste of chickpea flour, tamarind, and jaggery over colocasia (taro) leaves (alu). The leaves are rolled up neatly, steamed, sliced into pinwheels, and shallow-fried until beautifully crisp.",
    image: gAlu,
  },
  {
    title: "Varan Bhaat",
    emoji: "🥞",
    color: "#F4E8C8",
    desc: "The ultimate comfort food in Maharashtrian households. It consists of steaming hot white rice (bhaat) topped with a simple, un-spiced tuar dal cooked with turmeric and asafoetida (varan), finished with a generous dollop of pure homemade ghee and a wedge of lemon. It is also the essential first course during weddings and festivals.",
    image: gVaran,
  },
];
