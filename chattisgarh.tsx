import { useState } from "react";   //////doneeeeeeeeeeee
...
const danteshwar31 = "https://i.postimg.cc/6qVH0065/image.png";
...
/* ─── Main page ──────────────────────────────────────────────────────────── */
export default function ChattisgarhPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-5xl mx-auto px-6 py-12 space-y-16">
        ...
        <Section title="Map of Chattisgarh" icon="🗺️">
          <div className="flex flex-col items-center gap-3">
            <div
              ...
              style={{ maxWidth: 520 }}
              onClick={() => openLightbox(chattisgarhMap, "Map of Chattisgarh")}
            >
              <img
                src={chattisgarhMap}
                alt="Map of Chattisgarh"
